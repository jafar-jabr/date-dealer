...
exports.timeStampOf = date => {
  ...
  return Math.ceil(dateObject.valueOf()/1000)
};
...
exports.atThisMoment = (format = 'd-m-yyyy HH:MM:ss') => {
  const today = new Date();
  return formatter.dateFormat(today, format);
};

exports.yesterday = (format = 'dd-mm-yyyy') => {
  const yesterday = new Date();
  yesterday.setDate(yesterday.getDate() - 1);
  return formatter.dateFormat(yesterday, format);
};

exports.mondayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 0;
  ...
  return formatter.dateFormat(mondayDate, format);
};
exports.tuesdayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 1;
  const dateObject = new Date();
  const currentIndex = exports.getDayIndex(dateObject);
  const mondayDate = dateObject.setDate(dateObject.getDate() - (currentIndex - targetIndex));
...
exports.wednesdayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 2;
  const dateObject = new Date();
  const currentIndex = exports.getDayIndex(dateObject);
  const mondayDate = dateObject.setDate(dateObject.getDate() - (currentIndex - targetIndex));
...
exports.thursdayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 3;
  const dateObject = new Date();
  const currentIndex = exports.getDayIndex(dateObject);
  const mondayDate = dateObject.setDate(dateObject.getDate() - (currentIndex - targetIndex));
...
exports.fridayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 4;
  const dateObject = new Date();
  const currentIndex = exports.getDayIndex(dateObject);
  const mondayDate = dateObject.setDate(dateObject.getDate() - (currentIndex - targetIndex));
...
exports.sundayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 5;
  const dateObject = new Date();
  const currentIndex = exports.getDayIndex(dateObject);
  const mondayDate = dateObject.setDate(dateObject.getDate() - (currentIndex - targetIndex));
...
exports.saturdayThisWeek = (format = 'dd-mm-yyyy') => {
  const targetIndex = 6;
  const dateObject = new Date();
  const currentIndex = exports.getDayIndex(dateObject);
  const mondayDate = dateObject.setDate(dateObject.getDate() - (currentIndex - targetIndex));
